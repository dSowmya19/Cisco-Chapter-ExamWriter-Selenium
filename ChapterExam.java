...
public class ChapterExam {
	...
	public static void main(String args[]) throws InterruptedException, AWTException ,IOException{
		...
		driver.get("https://lms.netacad.com/mod/quiz/attempt.php?attempt=15393718&cmid=15677176");
		WebElement element = wait.until(ExpectedConditions.presenceOfElementLocated(By.id("idp-discovery-username")));
		element.sendKeys("morampudidevisowmya008@gmail.com");
		driver.findElementById("idp-discovery-submit").click();
		Thread.sleep(5000);
		driver.findElementById("okta-signin-password").sendKeys("Samantha19*");
		...
		while (true) 
		{
			...
			if(first == true)
			{
				...
				driver.get("https://www.premiumexam.net/cybersecurity-essentials-1-1/cybersecurity-essentials-1-1-chapter-1-quiz-answers-100-2018/");
				first = false;
			}
